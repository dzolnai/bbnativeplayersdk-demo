...
/**
 * An ShortsShelfFragment [Fragment] subclass.
 * When the player is in view play the video
 * but when not in view stop playing the video
 */
class ShortsShelfFragment : Fragment(), BBNativeShortsViewDelegate {
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		Logger.d("ShortsShelfFragment", "json url: $jsonUrl")

		fragmentActivity = requireActivity()
		val options = HashMap<String, Any?>()
		options.put("displayFormat", "list")
		shortsView = BBNativeShorts.createShortsView(fragmentActivity, jsonUrl, options)
	...
	override fun onCreateView(
		...
		val shortsFragment: View = inflater.inflate(R.layout.fragment_shorts_shelf, null)
		containerView = shortsFragment.findViewById(R.id.shortsShelfContainerView)
